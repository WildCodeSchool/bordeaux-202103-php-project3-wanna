 ...
 */
final class Version20210714084924 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE notification ADD project_id INT DEFAULT NULL, ADD target_path VARCHAR(255) NOT NULL, ADD target_path_fragment VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE notification DROP project_id, DROP target_path, DROP target_path_fragment');
    }
}
